...
void Space::updateMoveRight(Actor *dynamicAct)
{
  if (dynamicAct->vx > 0)
  {
    ...
    for (auto const &staticAct : staticActors)
    {
      ...
      if ((rightDynamic + dynamicAct->vx) >= leftStatic && rightDynamic <= leftStatic && topStatic < downDynamic && downStatic > topDynamic)
      {
...
void Space::updateMoveLeft(Actor *dynamicAct)
{
  if (dynamicAct->vx < 0)
  {
    ...
    for (auto const &staticAct : staticActors)
    {
      ...
      // Alerta!, Elemento estático en la trayectoria.
      if ((leftDynamic + dynamicAct->vx) <= rightStatic && leftDynamic >= rightStatic && topStatic < downDynamic && downStatic > topDynamic)
      {
...
void Space::updateMoveDown(Actor *dynamicAct)
{
  if (dynamicAct->vy > 0)
  {
    ...
    for (auto const &staticAct : staticActors)
    {
      ...
      // Alerta!, Elemento estático en la trayectoria.
      if ((downDynamic + dynamicAct->vy) >= topStatic && topDynamic < downStatic && leftDynamic < rightStatic && rightDynamic > leftStatic)
      {
...
void Space::updateMoveTop(Actor *dynamicAct)
{
  if (dynamicAct->vy < 0)
  {
    ...
    for (auto const &staticAct : staticActors)
    {
      ...
      // Alerta!, Elemento estático en la trayectoria.
      if ((topDynamic + dynamicAct->vy) <= downStatic && downDynamic > topStatic && leftDynamic < rightStatic && rightDynamic > leftStatic)
      {
